...
public class SortClothes extends AppCompatActivity implements View.OnClickListener{
    ...
    private RecyclerView recycler_clothes;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recycler_clothes = (RecyclerView) findViewById( R.id.recycler_clothes );
        netFailed = findViewById( R.id.layout_net_failed3 );
        ...
        initGoods(jsonStr);
        //进度框显示方法一
        progressDialog = DialogUIUtils.showLoadingDialog( SortClothes.this,"正在查询..." );
        progressDialog.show();
    }
            ...
            public void onFailure(Call call, IOException e) {
                runOnUiThread( new Runnable() {
                    ...
                    public void run() {
                        ...
                        recycler_clothes.setVisibility( View.GONE );
                        netFailed.setVisibility( View.VISIBLE );
                        Toast.makeText( SortClothes.this, "当前网络不给力哦！", Toast.LENGTH_SHORT ).show();
                    }
                } );
            }
                ...
                if(flag == 200){
                    runOnUiThread( new Runnable() {
                        ...
                        public void run() {
                            ...
                            dismiss(progressDialog);
                            Log.i( TAG, "run: 查询成功！" );
                            Toast.makeText( SortClothes.this, "查询成功！", Toast.LENGTH_SHORT ).show();
                    ...
                    runOnUiThread( new Runnable() {
                        ...
                        public void run() {
                            //取消进度框一
                            dismiss(progressDialog);
                            Toast.makeText( SortClothes.this, "登录信息无效，请重新登录！", Toast.LENGTH_SHORT ).show();
                        }
                    } );
                }
                else{
                    runOnUiThread( new Runnable() {
                        ...
                        public void run() {
                            //取消进度框一
                            dismiss(progressDialog);
                            Toast.makeText( SortClothes.this, "查询失败！", Toast.LENGTH_SHORT ).show();
                        }
                    } );
                }
            }
